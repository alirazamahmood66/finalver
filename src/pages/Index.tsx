...
// Services section images - unique for each service
const interiorImg = "/images/interior-detailing.jpg";
const exteriorImg = "/images/exterior-detailing.jpg";
const waxImg = "/images/super-wax-detail.jpg";

// How It Works section images - unique for each step
const serviceSelectionImg = "/images/service-selection.jpg";
const bookingAppointmentImg = "/images/booking-appointment.jpg";
const detailingProcessImg = "/images/detailing-process.jpg";
const finishedResultImg = "/images/finished-result.jpg";

// Additional Benefits section images - unique for each benefit
const ecoFriendlyImg = "/images/eco-friendly-wash.jpg";
const ceramicCoatingImg = "/images/ceramic-coating.jpg";
const mobileDetailingImg = "/images/mobile-detailing.jpg";
